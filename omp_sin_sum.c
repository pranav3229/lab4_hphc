...
#  ifdef BLOCK_PARTITIONING
#    pragma omp parallel for num_threads(thread_count) \
      reduction(+: approx) schedule(static, 1)
#  elif defined(CYCLIC_PARTITIONING)
#    pragma omp parallel for num_threads(thread_count) \
      reduction(+: approx) schedule(static, n/thread_count)
#  elif defined(DYNAMIC_SCHEDULE)
#    pragma omp parallel for num_threads(thread_count) \
      reduction(+: approx) schedule(dynamic)
#  elif defined(GUIDED_SCHEDULE)
#    pragma omp parallel for num_threads(thread_count) \
...
// administrator@ipc:~/Downloads/Lab 4 on OpenMP$ gcc -o program omp_sin_sum.c -fopenmp -DGUIDED_SCHEDULE -lm
// ./program 2 2                                  
// Result = 1.76161649722379e-01
// Check = 1.76161649722379e-01
// With n = 2 terms, the error is 0.00000000000000e+00
// Elapsed time = 8.655000e-05 seconds


// administrator@ipc:~/Downloads/Lab 4 on OpenMP$ gcc -o program omp_sin_sum.c -fopenmp -DDYNAMIC_SCHEDULE -lm
// administrator@ipc:~/Downloads/Lab 4 on OpenMP$ ./program 2 2
// Result = 1.76161649722379e-01
// Check = 1.76161649722379e-01
// With n = 2 terms, the error is 0.00000000000000e+00
// Elapsed time = 1.125250e-04 seconds

// administrator@ipc:~/Downloads/Lab 4 on OpenMP$ gcc -o program omp_sin_sum.c -fopenmp -DCYCLIC_PARTITIONING -lm
// administrator@ipc:~/Downloads/Lab 4 on OpenMP$ ./program 2 2
// Result = 1.76161649722379e-01
// Check = 1.76161649722379e-01
// With n = 2 terms, the error is 0.00000000000000e+00
// Elapsed time = 1.043250e-04 seconds


// administrator@ipc:~/Downloads/Lab 4 on OpenMP$ gcc -o program omp_sin_sum.c -fopenmp -DBLOCK_PARTITIONING -lm
// administrator@ipc:~/Downloads/Lab 4 on OpenMP$ ./program 2 2
// Result = 1.76161649722379e-01
// Check = 1.76161649722379e-01
// With n = 2 terms, the error is 0.00000000000000e+00
// Elapsed time = 1.038660e-04 seconds